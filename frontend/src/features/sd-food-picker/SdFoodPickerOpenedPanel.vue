...
<template>
  <div
    ...
    data-sd-food-picker-opened-panel
  ...
  >
    <section class="food-picker-stage" aria-label="今天吃什么 面板">
      ...
      <button
        ...
        type="button"
        data-sd-action="food-picker-pick"
...
.opened-food-picker-panel {
  ...
  background:
    radial-gradient(
      circle at 67% 23%,
      var(
        --sd-theme-food-picker-food-picker-opened-panel-accent-surface-01
      ),
      transparent 24%
    ),
    var(--sd-theme-food-picker-food-picker-opened-panel-surface-01);
  color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-text-01
  );
}
...
.food-picker-stage h2 {
  margin: 0 0 28px;
  color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-text-02
  );
  font-size: 34px;
  font-weight: 700;
  line-height: 42px;
...
.food-wheel {
  ...
  background: conic-gradient(
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-02)
      0 16.6%,
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-03)
      16.6% 33.2%,
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-04)
      33.2% 49.8%,
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-05)
      49.8% 66.4%,
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-06)
      66.4% 83%,
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-surface-07)
      83% 100%
  );
  color: var(--sd-theme-food-picker-food-picker-opened-panel-text-01);
}
...
.food-picker-primary {
  ...
  border-radius: 22px;
  background: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-surface-08
  );
  color: var(--sd-theme-food-picker-food-picker-opened-panel-text-01);
  font-size: 18px;
  line-height: 42px;
...
.food-picker-menu-editor span {
  color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-text-03
  );
  font-size: 12px;
  line-height: 18px;
  white-space: nowrap;
...
.food-picker-menu-editor textarea {
  ...
  padding: 12px 14px;
  border: 1px solid
    var(--sd-theme-food-picker-food-picker-opened-panel-accent-border-01);
  border-radius: 12px;
  background: var(
    --sd-theme-food-picker-food-picker-opened-panel-surface-02
  );
  color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-text-01
  );
...
.food-picker-menu-editor textarea:focus {
  border-color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-border-02
  );
  box-shadow: 0 0 0 3px
    var(--sd-theme-food-picker-food-picker-opened-panel-shadow-01);
}
...
.food-picker-editor-actions button {
  ...
  border-radius: 17px;
  background: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-surface-09
  );
  color: var(
    --sd-theme-food-picker-food-picker-opened-panel-accent-text-01
  );
