...
.opened-tomato-body {
  ...
  height: 100%;
  overflow: hidden;
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-01);
}
...
.opened-tomato-body::after {
  ...
  z-index: 1;
  background: var(
    --sd-theme-pomodoro-pomodoro-opened-panel-accent-surface-01
  );
  content: "";
}
...
.opened-tomato-theme {
  ...
  justify-content: center;
  margin-bottom: 18px;
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-02);
...
.tomato-dial {
  ...
  height: 360px;
  place-items: center;
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-03);
}
...
.tomato-dial-ring {
  ...
  width: 360px;
  height: 360px;
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-04);
}
...
.tomato-dial-ring .tomato-progress-track {
  stroke: var(--sd-theme-pomodoro-pomodoro-opened-panel-surface-01);
}

.tomato-dial-ring .tomato-progress-fill {
  stroke: var(--sd-theme-pomodoro-pomodoro-opened-panel-surface-02);
  stroke-linecap: butt;
  transition:
...
.opened-tomato-control {
  ...
  overflow: hidden;
  border: 2px solid
    var(--sd-theme-pomodoro-pomodoro-opened-panel-border-01);
  border-radius: 999px;
  background: var(--sd-theme-pomodoro-pomodoro-opened-panel-surface-03);
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-02);
  backdrop-filter: blur(10px);
}

.opened-tomato-start {
  border-color: var(--sd-theme-pomodoro-pomodoro-opened-panel-border-02);
  background: var(--sd-theme-pomodoro-pomodoro-opened-panel-surface-04);
}

.opened-tomato-stop {
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-05);
}
...
.opened-tomato-audio {
  ...
  border: 0;
  background: transparent;
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-text-06);
}
...
.opened-tomato-audio.blocked {
  color: var(--sd-theme-pomodoro-pomodoro-opened-panel-accent-text-01);
}
