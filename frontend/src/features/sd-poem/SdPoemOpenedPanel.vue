...
import { useSdPoemRuntime } from "./useSdPoemRuntime";
...
const emit = defineEmits<{
  updateData: [data: SdPoemWidgetData];
}>();
...
<template>
  <div
    class="sd-poem-opened-panel"
    data-sd-poem-opened-panel
        ...
        >
          ...
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <path
              ...
              fill="var(--poem-wave-back, var(--sd-poem-wave-back))"
              fill-opacity="0.6"
            />
            <path
              ...
              fill="var(--poem-wave-middle, var(--sd-poem-wave-middle))"
              fill-opacity="0.6"
            />
            <path
              ...
              fill="var(--poem-wave-front, var(--sd-poem-wave-front))"
              fill-opacity="0.3"
            />
          </g>
        </svg>
...
.sd-poem-opened-panel {
  ...
  background: var(
    --poem-bg,
    var(--sd-theme-poem-poem-opened-panel-surface-01)
  );
  color: var(--sd-theme-poem-poem-opened-panel-text-01);
  font-family:
    "PingFang SC",
    -apple-system,
    BlinkMacSystemFont,
...
.sd-poem-opened-panel::-webkit-scrollbar {
  display: none;
}

:global([data-sd-scheme="dark"] .sd-poem-opened-panel),
:global([data-sd-theme="dark"] .sd-poem-opened-panel) {
  --poem-bg: var(
...
.opened-poem-quotes p {
  margin: 0 0 20px;
  color: var(--sd-theme-poem-poem-opened-panel-text-02);
  font-size: 14px;
  line-height: 21px;
}
...
.opened-poem-quotes button:not(.opened-poem-chevron) {
  ...
  height: 34px;
  padding: 0;
  border: 1px solid var(--sd-theme-poem-poem-opened-panel-border-01);
  border-radius: 5px;
  background: var(--sd-theme-poem-poem-opened-panel-surface-02);
  color: var(--sd-theme-poem-poem-opened-panel-text-01);
  font-size: 13px;
  line-height: 32px;
}
...
.opened-poem-quotes button:not(.opened-poem-chevron):hover {
  background: var(--sd-theme-poem-poem-opened-panel-surface-03);
}
...
.opened-poem-detail {
  ...
  margin: 120px auto 0;
  padding: 0 0 50px;
  color: var(--sd-theme-poem-poem-opened-panel-text-03);
  line-height: 1.6;
  text-align: start;
}
...
.opened-poem-card {
  ...
  padding: 20px;
  overflow: hidden;
  border: 1px solid var(--sd-theme-poem-poem-opened-panel-border-02);
  border-radius: 4px;
  background: var(--sd-theme-poem-poem-opened-panel-surface-04);
  box-shadow: none;
}
...
.opened-poem-author {
  margin: 0 0 20px;
  color: var(--sd-theme-poem-poem-opened-panel-text-04);
  font-size: 12px;
  line-height: 19.2px;
}
...
.opened-poem-chevron {
  ...
  color: var(--sd-theme-poem-poem-opened-panel-text-05);
