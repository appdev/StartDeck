...
import { SD_POEM_ICON_URL, useSdPoemRuntime } from "./useSdPoemRuntime";
...
const runtime = useSdPoemRuntime(widgetRef, (data) => {
...
<template>
  <span
    class="sd-poem-widget"
    data-sd-poem-widget
    :data-sd-poem-size="sizeKey"
    :data-sd-poem-source-status="runtime.sourceStatus.value"
  ...
  >
    ...
    >
      <img v-if="sizeKey === '1x1'" alt="今日诗词" :src="SD_POEM_ICON_URL" />
      <template v-else>
...
:global([data-sd-scheme="dark"] .sd-poem-widget),
