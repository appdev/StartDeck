...
<template>
  <div
    class="sd-daily-english-opened-panel"
    :class="{ playing }"
  ...
  >
    ...
    <button
      ...
      data-sd-hotspot-id="today-english-play"
      data-sd-action="toggle-audio-progress"
...
.sd-daily-english-opened-panel {
  ...
  border-radius: 20px;
  background: var(
    --sd-theme-daily-english-daily-english-opened-panel-surface-01
  );
  color: var(--sd-theme-daily-english-daily-english-opened-panel-text-01);
}
...
.opened-english-shade {
  background: var(
    --sd-theme-daily-english-daily-english-opened-panel-surface-02
  );
}
...
.opened-english-copy em {
  display: block;
  margin-top: 12px;
  color: var(--sd-theme-daily-english-daily-english-opened-panel-text-02);
  font-size: 13px;
  font-style: normal;
  line-height: 20px;
}
...
.opened-english-play {
  ...
  border-radius: 50%;
  background: var(
    --sd-theme-daily-english-daily-english-opened-panel-surface-03
  );
  color: var(--sd-theme-daily-english-daily-english-opened-panel-text-01);
  transform: translateX(-50%);
}
