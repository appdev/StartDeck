...
.flip-card {
  ...
  box-shadow: var(
    --flip-shadow,
    0 2px 8px var(--sd-theme-clock-flip-card-shadow-01)
  );
  color: var(--flip-text-color, var(--sd-theme-clock-flip-card-text-01));
  font-family: var(
    --flip-font-family,
    "DIN",
    "Roboto Mono",
...
.flip-card::after {
  ...
  background: var(
    --flip-center-line,
    var(--sd-theme-clock-flip-card-surface-01)
  );
  box-shadow: var(
    --flip-center-line-shadow,
    0 1px 0 var(--sd-theme-clock-flip-card-shadow-02)
  );
  content: "";
}
...
.flip-card__top {
  ...
  border-bottom: 1px solid
    var(--flip-border-color, var(--sd-theme-clock-flip-card-border-01));
  border-radius: var(--flip-card-radius, 6px) var(--flip-card-radius, 6px) 0 0;
  background: var(
    --flip-bg-top,
    linear-gradient(
      180deg,
      var(--sd-theme-clock-flip-card-accent-surface-01) 0%,
      var(--sd-theme-clock-flip-card-accent-surface-02) 100%
    )
  );
}
...
.flip-card__bottom {
  ...
  background: var(
    ...
    linear-gradient(
      180deg,
      var(--sd-theme-clock-flip-card-accent-surface-02) 0%,
      var(--sd-theme-clock-flip-card-accent-surface-01) 100%
    )
  );
}
...
@keyframes flipDownShadow {
  0% {
    background: var(--sd-theme-clock-flip-card-surface-02);
  }
  100% {
    background: var(--sd-theme-clock-flip-card-surface-03);
  }
}

@keyframes flipUpShadow {
  0% {
    background: var(--sd-theme-clock-flip-card-surface-04);
  }
  100% {
    background: var(--sd-theme-clock-flip-card-surface-05);
  }
}
</style>
