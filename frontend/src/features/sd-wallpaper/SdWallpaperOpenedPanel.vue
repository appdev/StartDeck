...
const emit = defineEmits<{
  applied: [payload: SdWallpaperApplyPayload];
...
const persistWidgetWallpaperState = (entry: SdWallpaperEntry) => {
...
<template>
  <section
    ref="panelRef"
    class="sd-wallpaper-opened-panel"
    data-sd-wallpaper-opened-panel
  ...
  >
    <button
      ...
      data-sd-wallpaper-settings-trigger
    ...
    <div
      ...
      data-sd-wallpaper-settings-popover
    >
      <label>
        <input
    ...
    <p v-else class="wallpaper-empty-state" data-sd-wallpaper-empty-state>
    ...
    <div ref="loadMoreSentinelRef" class="wallpaper-opened-footer">
      ...
      <p
        ...
        :class="`is-${applyState}`"
        data-sd-wallpaper-apply-status
      >
        {{
...
.sd-wallpaper-opened-panel {
  ...
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-01);
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-accent-text-01);
  font-family:
    "PingFang SC",
    -apple-system,
    BlinkMacSystemFont,
...
.wallpaper-settings-trigger {
  ...
  border: 0;
  border-radius: 999px;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-02);
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-accent-text-02);
  padding: 0;
  box-shadow: 0 0 16px
    var(--sd-theme-wallpaper-wallpaper-opened-panel-shadow-01);
}
...
.wallpaper-settings-trigger.active {
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-03);
}
...
.wallpaper-settings-popover {
  ...
  gap: 14px;
  border-radius: 16px;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-04);
  box-shadow: 0 18px 48px
    var(--sd-theme-wallpaper-wallpaper-opened-panel-shadow-02);
  padding: 20px 22px;
}
...
.wallpaper-settings-popover label {
  ...
  align-items: center;
  gap: 10px;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-01);
  font-size: 15px;
  font-weight: 700;
}
...
.wallpaper-settings-popover input[type="checkbox"] {
  width: 18px;
  height: 18px;
  accent-color: var(--sd-theme-wallpaper-wallpaper-opened-panel-accent-01);
}
...
.wallpaper-panel-head h2 {
  margin: 0;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-02);
  font-size: 30px;
  font-weight: 800;
  line-height: 42px;
}
...
.wallpaper-panel-head p {
  margin: 0;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-03);
  font-size: 14px;
  line-height: 22px;
}
...
.wallpaper-featured-image {
  ...
  border: 0;
  border-radius: 12px;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-05);
  padding: 0;
  cursor: pointer;
}
...
.wallpaper-featured-copy {
  padding-top: 2px;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-04);
  font-size: 14px;
  line-height: 22px;
}
...
.wallpaper-featured-copy strong {
  display: block;
  margin-bottom: 10px;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-05);
  font-size: 16px;
  font-weight: 600;
  line-height: 24px;
}
...
.wallpaper-grid-card {
  ...
  border: 0;
  border-radius: 10px;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-06);
  padding: 0;
  box-shadow: none;
}
...
.wallpaper-grid-card.active::after {
  position: absolute;
  inset: 0;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-07);
  content: "";
}
...
.wallpaper-grid-card span {
  ...
  border-radius: 999px;
  background: var(--sd-theme-wallpaper-wallpaper-opened-panel-surface-08);
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-06);
  font-size: 26px;
  font-weight: 800;
}
...
.wallpaper-opened-footer button {
  ...
  border-radius: 999px;
  background: var(
    --sd-theme-wallpaper-wallpaper-opened-panel-accent-surface-01
  );
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-text-06);
  font-size: 14px;
  font-weight: 800;
...
.wallpaper-opened-footer p {
  margin: 0;
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-accent-text-03);
  font-size: 13px;
  font-weight: 700;
}

.wallpaper-opened-footer p.is-error {
  color: var(--sd-theme-wallpaper-wallpaper-opened-panel-accent-text-04);
}
