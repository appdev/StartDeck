...
.opened-ip-map-layer {
  ...
  background: linear-gradient(
    ...
    color-mix(
      in srgb,
      var(--sd-theme-itab-ip-ip-opened-panel-surface-01) 94%,
      var(--sd-theme-itab-ip-ip-opened-panel-text-02)
    ),
    color-mix(
      in srgb,
      var(--sd-theme-itab-ip-ip-opened-panel-surface-01) 82%,
      var(--sd-theme-itab-ip-ip-opened-panel-accent-text-01)
    )
  );
}
...
.opened-ip-map-layer::before {
  ...
  background:
    linear-gradient(
      ...
      color-mix(
          in srgb,
          var(--sd-theme-itab-ip-ip-opened-panel-text-02) 12%,
          transparent
        )
        47.4% 48.1%,
    ...
    linear-gradient(
      ...
      color-mix(
          in srgb,
          var(--sd-theme-itab-ip-ip-opened-panel-accent-text-01) 12%,
          transparent
        )
        54.4% 55.1%,
    ...
    radial-gradient(
      ...
      color-mix(
          in srgb,
          var(--sd-theme-itab-ip-ip-opened-panel-accent-text-01) 34%,
          transparent
        )
        0 4px,
      transparent 5px 100%
...
.opened-ip-map-attribution {
  ...
  background: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-surface-01) 72%,
    transparent
  );
  backdrop-filter: blur(14px) saturate(1.25);
  color: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02) 74%,
    transparent
  );
  font-size: 11px;
  line-height: 16px;
...
.opened-ip-map-empty span {
  color: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02) 50%,
    transparent
  );
  font-size: 14px;
  line-height: 20px;
...
.opened-ip-info-card {
  ...
  border: 1px solid
    color-mix(
      in srgb,
      var(--sd-theme-itab-ip-ip-opened-panel-text-02) 16%,
      transparent
    );
  border-radius: 8px;
  background: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-surface-01) 76%,
    transparent
  );
  box-shadow: 0 18px 40px
    color-mix(
      in srgb,
      var(--sd-theme-itab-ip-ip-opened-panel-text-02) 14%,
      transparent
    );
...
.opened-ip-kicker {
  ...
  color: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-accent-text-01) 84%,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02)
  );
  font-size: 12px;
  font-weight: 600;
...
.opened-ip-latency-value {
  ...
  border: 1px solid
    color-mix(
      in srgb,
      var(--sd-theme-itab-ip-ip-opened-panel-text-02) 20%,
      transparent
    );
  border-radius: 7px;
  background: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02) 9%,
    transparent
  );
  color: var(--sd-theme-itab-ip-ip-opened-panel-text-02);
...
.opened-ip-latency-value.is-testing {
  color: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02) 64%,
    transparent
  );
}
...
.opened-ip-latency-action {
  ...
  background: color-mix(
    in srgb,
    var(--sd-theme-itab-ip-ip-opened-panel-accent-text-01) 68%,
    var(--sd-theme-itab-ip-ip-opened-panel-text-02)
  );
  color: var(--sd-theme-itab-ip-ip-opened-panel-surface-01);
  cursor: pointer;
  font: inherit;
  font-size: 13px;
  font-weight: 600;
