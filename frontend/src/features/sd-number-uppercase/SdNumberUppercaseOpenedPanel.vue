...
import { useSdNumberUppercaseRuntime } from "./useSdNumberUppercaseRuntime";
...
const emit = defineEmits<{
  updateData: [data: SdNumberUppercaseWidgetData];
}>();

const widgetRef = computed(() => props.widget);
const runtime = useSdNumberUppercaseRuntime(widgetRef, (data) =>
...
<template>
  <section
    class="sd-number-uppercase-opened-panel"
    data-sd-number-uppercase-panel
    :data-sd-number-uppercase-input="runtime.inputNumber.value"
    :data-sd-number-uppercase-result="runtime.uppercaseResult.value"
    :data-sd-number-uppercase-format="runtime.state.value.formatMode"
  >
...
<style scoped>
.sd-number-uppercase-opened-panel {
  position: relative;
  display: block;
  width: 100%;
  height: 100%;
  ...
  background: linear-gradient(
    135deg,
    var(
      --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-01
    ),
    var(
        --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-02
      )
      48%,
    var(
...
.amount-conversion-input {
  ...
  border: 1px solid
    var(
      --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-border-01
    );
  border-radius: 12px;
  outline: none;
  background: var(
  ...
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-text-01
  );
  font-size: 18px;
  line-height: 27px;
  text-align: center;
...
.amount-conversion-input::placeholder {
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-text-02
  );
}
...
.amount-conversion-input--active {
  border-color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-border-02
  );
  background: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-04
  );
  box-shadow: var(
      --sd-theme-number-uppercase-number-uppercase-opened-panel-shadow-01
    )
    0 0 3px 0;
}
...
.amount-conversion-result-container {
  ...
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-text-03
  );
  font-size: 18px;
  line-height: 28px;
  text-align: center;
...
.amount-conversion-example {
  ...
  border-radius: 10px;
  background: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-05
  );
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-text-04
  );
}
...
.amount-conversion-example-title {
  ...
  margin: 0 0 20px;
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-text-05
  );
  font-size: 16px;
  font-weight: 600;
  letter-spacing: 0;
...
.amount-conversion-character-item strong {
  color: var(
    --sd-theme-number-uppercase-number-uppercase-opened-panel-text-06
  );
  font-size: 20px;
  font-weight: 600;
  line-height: 30px;
...
.amount-conversion-bottom-border {
  ...
  background: linear-gradient(
    ...
    transparent,
    var(
      --sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-06
    ),
    transparent
  );
}
