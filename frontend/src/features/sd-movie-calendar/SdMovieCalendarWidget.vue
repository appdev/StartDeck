...
<template>
  <span
    class="sd-movie-calendar-widget"
    data-sd-movie-calendar-widget
    :data-sd-movie-calendar-size="sizeKey"
...
.movie-calendar-card {
  ...
  background: var(
    --movie-bg-color,
    var(--sd-theme-movie-calendar-movie-calendar-widget-surface-01)
  );
  color: var(
    --movie-text-color,
    var(--sd-theme-movie-calendar-movie-calendar-widget-text-01)
  );
  font-family:
    "PingFang SC",
    -apple-system,
...
.movie-card-bg {
  ...
  background:
    linear-gradient(
      ...
      var(--sd-theme-movie-calendar-movie-calendar-widget-surface-02)
    ),
...
.movie-calendar-card::after {
  ...
  z-index: 0;
  background: var(
    --sd-theme-movie-calendar-movie-calendar-widget-surface-03
  );
  content: "";
}
...
.movie-size-2-1 {
  box-shadow: 0 0 5px
    var(--sd-theme-movie-calendar-movie-calendar-widget-shadow-01);
}
...
.movie-size-2-4 {
  padding: 10px;
  box-shadow: 0 0 10px
    var(--sd-theme-movie-calendar-movie-calendar-widget-shadow-02);
}
...
.movie-calendar-icon {
  ...
  width: 86%;
  height: 86%;
  color: var(--sd-theme-movie-calendar-movie-calendar-widget-text-02);
  font-style: normal;
  line-height: 12px;
}
...
.movie-logo {
  ...
  justify-content: center;
  border-radius: 6px;
  color: var(--sd-theme-movie-calendar-movie-calendar-widget-text-03);
  font-size: 19.2px;
  font-weight: 700;
  line-height: 12px;
...
.movie-rating {
  ...
  border-radius: 6px;
  background: var(
    --sd-theme-movie-calendar-movie-calendar-widget-accent-surface-01
  );
  color: var(
    --sd-theme-movie-calendar-movie-calendar-widget-accent-text-01
  );
  font-size: 12px;
  line-height: 12px;
  white-space: nowrap;
