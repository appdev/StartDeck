...
import { useSdMemoRuntime } from "./useSdMemoRuntime";
import type { SdMemoSizeKey, SdMemoWidgetData } from "./sdMemoTypes";
...
const emit = defineEmits<{
  updateData: [data: SdMemoWidgetData];
}>();

const widgetRef = computed(() => props.widget);
const runtime = useSdMemoRuntime(
  widgetRef,
...
.sd-memo-widget {
  ...
  background: linear-gradient(
    135deg,
    var(--sd-theme-memo-memo-widget-accent-surface-01),
    var(--sd-theme-memo-memo-widget-accent-surface-02)
  );
  color: var(--sd-theme-memo-memo-widget-text-01);
}
...
.memo-widget-top {
  ...
  background-image: linear-gradient(
    0deg,
    var(--sd-theme-memo-memo-widget-accent-surface-03),
    var(--sd-theme-memo-memo-widget-accent-surface-04)
  );
  color: var(--sd-theme-memo-memo-widget-text-02);
  font-size: 12px;
  line-height: 1.5;
  text-align: center;
}
...
.sd-memo-widget[data-sd-memo-size="1x1"] .memo-widget-top,
.sd-memo-widget[data-sd-memo-size="1x2"] .memo-widget-top {
  height: 30%;
}

.sd-memo-widget.is-board .memo-widget-top {
  height: 38px;
...
.sd-memo-widget.is-board .memo-widget-top small {
  display: block;
  color: var(--sd-theme-memo-memo-widget-text-02);
  font-size: 11px;
  line-height: 16px;
...
.memo-widget-content {
  ...
  padding: 0;
  overflow: hidden;
  background-color: var(--sd-theme-memo-memo-widget-surface-01);
  list-style: none;
}

.sd-memo-widget.is-board .memo-widget-content {
...
.sd-memo-widget.is-board .memo-widget-content::-webkit-scrollbar {
  width: var(--sd-scrollbar-size);
}

.sd-memo-widget.is-board .memo-widget-content::-webkit-scrollbar-thumb {
  border-radius: 999px;
  background: var(--sd-scrollbar-thumb);
}

.sd-memo-widget.is-board .memo-widget-content::-webkit-scrollbar-thumb:hover {
  background: var(--sd-scrollbar-thumb-hover);
}

.sd-memo-widget.is-board .memo-widget-content::-webkit-scrollbar-track {
  background: var(--sd-scrollbar-track);
}

.sd-memo-widget[data-sd-memo-size="1x1"] .memo-widget-content,
.sd-memo-widget[data-sd-memo-size="1x2"] .memo-widget-content {
  height: 70%;
}
...
.memo-widget-content li {
  ...
  align-items: center;
  padding: 0 6.51px;
  border-bottom: 1px solid var(--sd-theme-memo-memo-widget-border-01);
  font-size: 12px;
  line-height: 18px;
}

.sd-memo-widget.is-board .memo-widget-content li {
  position: relative;
  height: auto;
  min-height: 58px;
...
.sd-memo-widget.is-compact-text-hidden .memo-widget-content span {
  display: none;
}

.sd-memo-widget.is-board .memo-widget-content span {
  display: block;
}
</style>
