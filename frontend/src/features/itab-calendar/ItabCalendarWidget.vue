...
import { useItabCalendarRuntime } from "./useItabCalendarRuntime";
import type { ItabCalendarWidgetData } from "./itabCalendarTypes";
...
<template>
  <span
    class="itab-calendar-widget"
    :class="`size-${normalizedSize}`"
    data-itab-calendar-widget
    :data-itab-calendar-size="sizeKey"
    :data-itab-calendar-date="today.key"
  >
