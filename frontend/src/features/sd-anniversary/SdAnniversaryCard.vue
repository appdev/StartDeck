...
import type { SdAnniversaryTemplate } from "./sdAnniversaryTypes";
...
<template>
  <span
    ...
    :style="style"
    :data-sd-anniversary-card-size="cardTemplate.sizeKey"
  >
...
.variant-mini {
  box-shadow: 0 0 10px 3px
    var(--sd-theme-anniversary-anniversary-card-shadow-01);
}

.variant-preview {
  box-shadow: 0 8px 18px
    var(--sd-theme-anniversary-anniversary-card-shadow-02);
}
...
.is-payday .anniversary-card-copy > span {
  height: 44px;
  color: var(--sd-theme-anniversary-anniversary-card-text-01);
  font-size: 14px;
  font-weight: 600;
  line-height: 44px;
}
...
.sd-anniversary-card.size-1-1:not(.is-payday),
.sd-anniversary-card.size-1-2:not(.is-payday),
.sd-anniversary-card.size-2-1:not(.is-payday),
.sd-anniversary-card.size-2-4.with-calendar:not(.is-payday) {
  display: block;
  padding: 0;
  text-align: center;
}

.sd-anniversary-card.size-1-1:not(.is-payday) .anniversary-card-copy,
.sd-anniversary-card.size-1-2:not(.is-payday) .anniversary-card-copy,
.sd-anniversary-card.size-2-1:not(.is-payday) .anniversary-card-copy,
.sd-anniversary-card.size-2-4.with-calendar:not(.is-payday)
  .anniversary-card-copy {
  position: relative;
  width: 100%;
...
.sd-anniversary-card.size-1-1:not(.is-payday) .anniversary-card-copy > span {
  position: absolute;
  top: 10px;
  left: -6px;
  width: 72px;
...
.sd-anniversary-card.size-1-1:not(.is-payday) .anniversary-card-copy strong {
  position: absolute;
  top: 28px;
  left: -6px;
  width: 72px;
...
.sd-anniversary-card.size-1-1:not(.is-payday) .anniversary-card-copy small,
.sd-anniversary-card.size-1-1:not(.is-payday) .anniversary-card-copy em {
  display: none;
}

.sd-anniversary-card.size-1-2:not(.is-payday) .anniversary-card-copy > span {
  position: absolute;
  top: 12px;
  left: 12px;
  width: 71px;
...
.sd-anniversary-card.size-1-2:not(.is-payday) .anniversary-card-copy strong {
  position: absolute;
  top: 18px;
  left: 93px;
  width: 45px;
...
.sd-anniversary-card.size-1-2:not(.is-payday) .anniversary-card-copy small {
  display: none;
}

.sd-anniversary-card.size-1-2:not(.is-payday) .anniversary-card-copy em {
  position: absolute;
  top: 30px;
  left: 12px;
  width: 71px;
...
.sd-anniversary-card.size-2-1:not(.is-payday) .anniversary-card-copy > span {
  position: absolute;
  top: 12px;
  left: 0;
  width: 60px;
...
.sd-anniversary-card.size-2-1:not(.is-payday) .anniversary-card-copy strong {
  position: absolute;
  top: 63px;
  left: 7px;
  width: 45px;
...
.sd-anniversary-card.size-2-1:not(.is-payday) .anniversary-card-copy small {
  display: none;
}

.sd-anniversary-card.size-2-1:not(.is-payday) .anniversary-card-copy em {
  position: absolute;
  top: 99px;
  left: 0;
  width: 60px;
...
.sd-anniversary-card.size-2-4:not(.with-calendar):not(.is-payday) {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 17px;
...
.anniversary-card-calendar i:nth-child(7) {
  color: var(--sd-theme-anniversary-anniversary-card-accent-text-01);
}
...
.anniversary-card-calendar .today {
  ...
  border-radius: 50%;
  background: var(
    --sd-theme-anniversary-anniversary-card-accent-surface-01
  );
  color: var(--sd-theme-anniversary-anniversary-card-text-01);
  line-height: 15px;
}
