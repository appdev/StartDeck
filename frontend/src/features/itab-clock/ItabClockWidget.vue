...
const emit = defineEmits<{
  updateData: [data: ItabClockWidgetData];
}>();

const widgetRef = computed(() => props.widget);
const runtime = useItabClockRuntime(widgetRef, (data) =>
...
<template>
  <span
    class="itab-clock-widget is-clock"
    :class="`size-${normalizedSize}`"
    data-itab-clock-widget
    :data-itab-clock-size="sizeKey"
  >
