...
const darkOpenedPanelCriticalTokens = [
  ...
  "--sd-theme-anniversary-anniversary-opened-panel-text-01",
  "--sd-theme-calendar-calendar-opened-panel-surface-01",
  "--sd-theme-calendar-calendar-opened-panel-text-01",
  "--sd-theme-food-picker-food-picker-opened-panel-surface-01",
  "--sd-theme-food-picker-food-picker-opened-panel-text-01",
  "--sd-theme-ip-ip-opened-panel-surface-01",
  "--sd-theme-ip-ip-opened-panel-text-01",
  "--sd-theme-memo-memo-opened-panel-surface-01",
  "--sd-theme-memo-memo-opened-panel-text-01",
  "--sd-theme-poem-poem-opened-panel-surface-01",
  "--sd-theme-poem-poem-opened-panel-text-01",
  "--sd-theme-todo-todo-opened-panel-surface-01",
  "--sd-theme-todo-todo-opened-panel-text-01",
  "--sd-theme-wallpaper-wallpaper-opened-panel-surface-01",
  "--sd-theme-wallpaper-wallpaper-opened-panel-text-01",
  "--sd-theme-weather-weather-opened-panel-surface-00",
  "--sd-theme-weather-weather-opened-panel-text-01",
] as const;
...
const lightOuterWidgetCriticalTokens = [
  "--sd-theme-calendar-calendar-widget-surface-01",
  "--sd-theme-calendar-calendar-widget-text-01",
  "--sd-theme-calendar-calendar-widget-text-03",
  "--sd-theme-calendar-calendar-widget-text-06",
  "--sd-theme-clock-clock-widget-surface-01",
  "--sd-theme-clock-clock-widget-text-01",
  "--sd-theme-memo-memo-widget-surface-01",
  "--sd-theme-memo-memo-widget-text-01",
  "--sd-theme-number-uppercase-number-uppercase-opened-panel-accent-surface-03",
  "--sd-theme-number-uppercase-number-uppercase-opened-panel-surface-01",
  "--sd-theme-number-uppercase-number-uppercase-opened-panel-text-01",
  "--sd-theme-number-uppercase-number-uppercase-widget-accent-surface-03",
  "--sd-theme-todo-todo-widget-surface-01",
  "--sd-theme-todo-todo-widget-text-01",
] as const;

const darkOuterWidgetCriticalTokens = [
  "--sd-theme-food-picker-food-picker-widget-accent-text-01",
  "--sd-theme-food-picker-food-picker-widget-surface-01",
  "--sd-theme-food-picker-food-picker-widget-text-01",
  "--sd-theme-poem-poem-widget-surface-01",
  "--sd-theme-poem-poem-widget-text-01",
  "--sd-theme-poem-poem-widget-text-02",
] as const;
...
describe("component color policy", () => {
  ...
  it("keeps theme coverage on all runtime widgets and global surfaces", () => {
    ...
    for (const file of [
      ...
      "frontend/src/features/sd-movie-calendar/SdMovieCalendarWidget.vue",
      "frontend/src/features/sd-number-uppercase/SdNumberUppercaseWidget.vue",
      "frontend/src/features/sd-food-picker/SdFoodPickerWidget.vue",
